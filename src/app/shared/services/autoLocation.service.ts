...
export class autoLocationService {
        ...
        try {
            ...
            watch.then((data: any) => {
                ...
                this.ngZone.run(() => {
                    ...
                    console.log('watch subscribe and date = ' + data + data.coords)
            ...
            watch.subscribe((data: any) => {
                ...
                this.ngZone.run(() => {
                    ...
                    if (this.lat, this.lng) {
                        ...
                        // 0.5 meter away
                        console.log('ditsance' + this.distance)
                        if (distance > 0.1) {
    ...
    updateMyLocation() {
        console.log('gonf to update my loation')
